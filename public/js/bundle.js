...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYWJmaXJreSIsImEiOiJjbGU4cXg1N3cwaTF3M3dtZTJ0YXlpbnp0In0.7gyOQMK55-5sLNbk_kjFCw';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51MdFvcF1XyvkeS7gRhuTwVkaTL7g5pQx0A1iqQ1WVfTgwXblWc1RjtofO3WkCLSnE30pdqPsdLMXbwIdD8B54Lm4000kka1apT'); // get checkout session from API
          _context.next = 4;
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./mapbox":"mapbox.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
